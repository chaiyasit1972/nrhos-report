...
class ChildController extends Controller
{
    ...
    public function actionIndex() {
        $names="งานคลินิกสุขภาพเด็กดี"; 
         return $this -> render('/site/child/index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names]);
    } 
    public function actionChild1Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/child/child1-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model'=>$model]);                
    } 
    public function actionChild1_preview($name,$d1,$d2) {
        ...
        return $this->render('/site/child/child1-preview',['mText'=>$this->mText,'names'=>$names,'dataProvider'=>$dataProvider,
                                   'sText'=>$this->sText,'date1' =>$date1,'date2' =>$date2]);         
    }
    public function actionChild2Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/child/child2-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model'=>$model]);                
    }
    ...
    public function actionChild3Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/child/child3-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model'=>$model]);                
    } 
