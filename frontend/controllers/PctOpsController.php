...
class PctOpsController extends Controller
{
    ...
    public function actionIndex1() {
        ...
        return $this->render('/site/pct-ops/ops1-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model]);
    }
    ...
    public function actionIndex2() {
        ...
        return $this->render('/site/pct-ops/ops2-index',['names'=>$names,'mText'=>$this->mText,'sText' =>$this->sText, 'model' => $model]);
    }
    ...
    public function actionIndex3() {
        ...
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=pct-ops/";   
               return $this->redirect($url.'ops3.mrt&d1='.$date1.'&d2='.$date2);                
        }        
        return $this->render('/site/pct-ops/ops3-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model]);
    }    
    public function actionIndex4() {
        ...
        if($model->load(Yii::$app->request->post())){
               ...
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=pct-ops/";   
               return $this->redirect($url.'ops4.mrt&d1='.$date1.'&d2='.$date2);                
        }        
        return $this->render('/site/pct-ops/ops3-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model]);
    }    
}