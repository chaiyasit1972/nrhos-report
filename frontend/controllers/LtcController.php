...
class LtcController extends Controller
{
    ...
    public function actionIndex() {
        $names="งาน Long Term Care(LTC)"; 
         return $this -> render('/site/ltc/index',['mText'=>$this->mText,'names'=>$names,'sText'=>$this->sText]);
    } 
    public function actionLtc1Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc1-index',['mText'=>$this->mText, 'names'=>$names, 'model' =>$model,'sText'=>$this->sText]);            
    } 
    public function actionLtc1_preview($name,$c,$a1,$a2) {
       ...
       try {
        ...
        return $this -> render('/site/ltc/ltc1-preview',['dataProvider' => $dataProvider, 'names' => $names, 
                                       'mText' => $this->mText, 'text' => $text,'sText'=>$this->sText]);            
    }    
    public function actionLtc2Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc2-index',['mText'=>$this->mText, 'names'=>$names, 'model' =>$model,'sText'=>$this->sText]);            
    }      
     ...
     public function actionLtc3Index()
    {
        ...
        if($model->load(Yii::$app->request->post())){
         ...
         return $this->render('/site/ltc/ltc3-index',['mText' => $this->mText,'names' => $names,
                                    'data'=>$listData, 'model' => $model,'sText'=>$this->sText]);       
    }    
   public function actionLtc3_preview($name,$d1,$d2,$t1,$v1) {
            ...
            case 0:
                $sql1="select pp.vn,pp.hn,pp.pname,pp.visitdate,pp.vstdate,October,November,December,January,February,March,April,May,June,July,
                  ...
                  concat(p.pname,p.fname,' ',p.lname) pname,p.birthdate ,p.person_id,substr(o.entry_datetime,1,10) visitdate,v.vstdate,
                             ...
                             and o.ovst_community_service_type_id in ('1','2','3','4','5','6','7') and p.village_id !='{$village_id}') pp
        ...
        return $this -> render('/site/ltc/ltc3-preview',['dataProvider' => $dataProvider,'names' => $names,
                                    ...
                                    'village_moo'=>$village_moo,'village_name'=>$village_name,'sText'=>$this->sText]);                                
    }        
     public function actionLtc4Index()
    {
        ...
        if($model->load(Yii::$app->request->post())){
         ...
         return $this->render('/site/ltc/ltc4-index',['mText' => $this->mText,'names' => $names, 
                             'model'=>$model, 'data'=>$listData,'sText'=>$this->sText]);       
    }  
    public function actionLtc4_preview($name,$d1,$t1) {
        ...
        return $this -> render('/site/ltc/ltc4-preview',['dataProvider' => $dataProvider,'names' => $names,
                                    'mText' => $this->mText,'date1'=>$date1,'type_name'=>$type_name,'sText'=>$this->sText]);                           
    }      
    public function actionLtc5Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc5-index',['mText'=>$this->mText, 'names'=>$names, 'model' =>$model,'sText'=>$this->sText]);            
    }     
    ...
    public function actionLtc6Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc6-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }     
    public function actionLtc7Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc7-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    } 
    public function actionLtc8Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc8-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }
     public function actionLtc8_preview($name,$d1,$s1) {
        ...
        return $this->render('/site/ltc/ltc8-preview',['mText'=>$this->mText,'names'=>$names,
                                 'dataProvider'=>$dataProvider, 'date1' =>$date1,'sname' =>$type_n,'sText'=>$this->sText]);      
    }    
    public function actionLtc9Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc9-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    } 
    ...
    public function actionLtc10Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc10-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }     
    public function actionLtc11Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ltc/ltc11-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }       
    public function actionLtc12Index() {
        $model = new Formmodel();
        $names="รายงาน Community Service"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;        
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ltc/";   
               return $this->redirect($url.'ltc6.mrt&d1='.$date1.'&d2='.$date2);                            
        }
            return $this -> render('/site/ltc/ltc11-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }   
    public function actionLtc13Index() {
        $model = new Formmodel();
        $names="รายงาน Special PP"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;        
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ltc/";   
               return $this->redirect($url.'ltc7.mrt&d1='.$date1.'&d2='.$date2);                            
        }
            return $this -> render('/site/ltc/ltc11-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }    
    public function actionLtc14Index() {
        $model = new Formmodel();
        $names="รายงานรายชื่อผู้ป่วยตามรหัสโรค(ICD-10) แยกตามหมู่บ้าน/ชุมชน"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;        
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ltc/";   
               return $this->redirect($url.'ltc14.mrt&d1='.$date1.'&d2='.$date2);                            
        }
            return $this -> render('/site/ltc/ltc11-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }       
    public function actionLtc15Index() {
        $model = new Formmodel();
        $names="รายงานจำนวนผู้ป่วยตามรหัสโรค(ICD-10 : Z508,Z74) แยกในเขต/นอกเขต รับผิดชอบ"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;        
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ltc/";   
               return $this->redirect($url.'ltc15.mrt&d1='.$date1.'&d2='.$date2);                            
        }
            return $this -> render('/site/ltc/ltc11-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }      
    public function actionLtc16Index() {
        $model = new Formmodel();
        $names="รายงานจำนวนผู้พิการที่ได้รับการจดทะเบียน แยกในเขต/นอกเขต รับผิดชอบ"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;        
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ltc/";   
               return $this->redirect($url.'ltc16.mrt&d1='.$date1.'&d2='.$date2);                            
        }
            return $this -> render('/site/ltc/ltc12-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }     
    public function actionLtc17Index() {
        $model = new Formmodel();
        $names="รายงานจำนวนผู้พิการแยกตามกลุ่มความพิการ แยกในเขต/นอกเขต รับผิดชอบ"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;        
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ltc/";   
               return $this->redirect($url.'ltc17.mrt&d1='.$date1.'&d2='.$date2);                            
        }
            return $this -> render('/site/ltc/ltc11-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }     
    public function actionLtc18Index() {
        $model = new Formmodel();
        $names="รายงานจำนวนผู้พิการได้รับการดูแลเยี่ยมบ้าน แยกในเขต/นอกเขต รับผิดชอบ"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;        
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ltc/";   
               return $this->redirect($url.'ltc18.mrt&d1='.$date1.'&d2='.$date2);                            
        }
            return $this -> render('/site/ltc/ltc11-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }   
    public function actionLtc19Index() {
        $model = new Formmodel();
        $names="รายงานจำนวนผู้พิการตามสิทธิการรักษาพยาบาล แยกในเขต/นอกเขต รับผิดชอบ"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;        
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=ltc/";   
               return $this->redirect($url.'ltc19.mrt&d1='.$date1.'&d2='.$date2);                            
        }
            return $this -> render('/site/ltc/ltc11-index',['mText'=>$this->mText,'names'=>$names,'model' => $model,'sText'=>$this->sText]);
    }      
