...
class NcdClinic1Controller extends Controller
{
    ...
    public function actionClinic2Index(){
       ...
       try {
        ...
        return $this->render('/site/ncd/clinic2-index',['names'=>$names,'mText'=>$this->mText, 'sText'=>$this->sText,
    ...
    public function actionClinic3Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ncd/clinic3-index',['mText'=>$this->mText, 'sText'=>$this->sText,
    ...
    public function actionClinic4Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ncd/clinic4-index',['mText'=>$this->mText,  'sText'=>$this->sText, 
                                         'names'=>$names,'model'=>$model]);
    } 
    public function actionClinic4_preview($name,$d1,$d2,$t) {
        ...
        return $this -> render('/site/ncd/clinic4-preview', ['dataProvider' => $dataProvider, 'names' => $names,
                                     'mText' => $this->mText,  'sText'=>$this->sText,
                                     'date1'=>$date1, 'date2'=>$date2, 'type_n'=>$type_n]);             
    }    
    public function actionClinic5Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ncd/clinic5-index',['mText'=>$this->mText,  'sText'=>$this->sText,
                                           'names'=>$names,'model'=>$model]);
    } 
    ...
    public function actionClinic6Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ncd/clinic6-index',['mText'=>$this->mText,  'sText'=>$this->sText,
                                          'names'=>$names,'model'=>$model]);
    } 
    ...
    public function actionClinic7Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/ncd/clinic7-index',['mText'=>$this->mText,'sText'=>$this->sText ,'names'=>$names,'model'=>$model]);
    } 
    public function actionClinic7_preview($name,$d1,$d2,$c) {
        ...
        return $this -> render('/site/ncd/clinic7-preview',['dataProvider' => $dataProvider,'names' => $names,'mText' => $this->mText,
                             'sText'=>$this->sText,'date1'=>$date1,'date2'=>$date2,'clinic_n'=>$clinic_n]);         
    }        
}    
