...
class DentalController extends Controller
{
    ...
    public function actionIndex() {
        $names="งานทันตกรรม"; 
         return $this -> render('/site/dental/index',['mText'=>$this->mText,'names'=>$names, 'sText' => $this->sText]);
    } 
        public function actionDental0Index(){
        $model = new Formmodel();             
        $names="รายงานการรับบริการทันตกรรม(แยกตามกิจกรรม)";                    
        if($model->load(Yii::$app->request->post())){
               ...
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=dental/";   
                return $this->redirect($url.'dental0.mrt&d1='.$date1.'&d2='.$date2.'&yrs='.$yrs.'&yra='.$yra);  
        }         
        return $this->render('/site/dental/dental17-index',['mText'=>$this->mText,'names'=>$names, 'sText'=>$this->sText,
                                    'model' => $model]);                
    }     
    public function actionDental1Index(){
        ...
        return $this->render('/site/dental/dental1-index',['mText'=>$this->mText,'names'=>$names,'sText' => $this->sText,
    ...
    public function actionDental1_preview($d1,$d2,$t) {
        ...
        return $this -> render('/site/dental/dental1-preview',['dataProvider' => $dataProvider,'names' => $names,'sText' => $this->sText,
    ...
    public function actionDental2Index(){
        ...
        return $this->render('/site/dental/dental2-index',['mText'=>$this->mText,'names'=>$names,'sText' => $this->sText, 'model' => $model]);                
    }      
    ...
    public function actionDental3Index(){
        ...
        return $this->render('/site/dental/dental3-index',['mText'=>$this->mText,'names'=>$names,'sText' => $this->sText, 'model' => $model]);                
    }    
    public function actionDental3_preview($name,$d1,$d2,$t) {
        ...
        return $this->render('/site/dental/dental4-index',['mText'=>$this->mText,'names'=>$names,'sText' => $this->sText, 'model' => $model]);                
    }  
    public function actionDental4_preview($name,$d1,$d2,$t) {
	   ...
	   from (select p.cid,p.patient_hn,p.person_id,p.pname,p.fname,p.lname,p.sex,p.birthdate,p.house_regist_type_id,p.death,
        ...
        return $this -> render('/site/dental/dental4-preview',['dataProvider' => $dataProvider,'names' => $names,'sText' => $this->sText,
                                    'mText' => $this->mText,'date1'=>$date1,'date2'=>$date2,'type'=>$type_n]);           
    }       
        ...
        return $this->render('/site/dental/dental5-index',['mText'=>$this->mText,'names'=>$names,'sText' => $this->sText, 'model' => $model]);                
    }      
    public function actionDental5_preview($name,$d1,$d2,$t) {
	   ...
	   from (select p.cid,p.patient_hn,p.person_id,p.pname,p.fname,p.lname,p.sex,p.birthdate,p.house_regist_type_id,p.death,
        ...
        return $this -> render('/site/dental/dental5-preview',['dataProvider' => $dataProvider,'names' => $names,'sText' => $this->sText,
                                    'mText' => $this->mText,'date1'=>$date1,'date2'=>$date2,'type'=>$type_n]);           
    }         
        ...
        return $this->render('/site/dental/dental6-index',['mText'=>$this->mText,'names'=>$names, 'sText' => $this->sText, 'model' => $model]);                
    }      
    public function actionDental6_preview($name,$d1,$d2,$t) {
	   ...
	   from (select p.cid,p.patient_hn,p.person_id,p.pname,p.fname,p.lname,p.sex,p.birthdate,p.house_regist_type_id,p.death,
        ...
        return $this -> render('/site/dental/dental6-preview',['dataProvider' => $dataProvider,'names' => $names,'sText' => $this->sText,
                                    'mText' => $this->mText,'date1'=>$date1,'date2'=>$date2,'type'=>$type_n]);           
    }      
        ...
        return $this->render('/site/dental/dental7-index',['mText'=>$this->mText,'names'=>$names, 'sText' => $this->sText, 'model' => $model]);                
    }   
    public function actionDental7_preview($name,$d1,$d2) {
	   ...
	   where p.death <> 'Y' and p.person_discharge_id='9' and
        ...
        return $this -> render('/site/dental/dental7-preview',['dataProvider' => $dataProvider,'names' => $names,'sText' => $this->sText,
        ...
        return $this->render('/site/dental/dental8-index',['mText'=>$this->mText,'names'=>$names,'sText' => $this->sText, 'model' => $model]);                
    }  
    public function actionDental8_preview($name,$d1,$d2) {
	   ...
	   where p.death <> 'Y' and p.person_discharge_id='9' and
        ...
        return $this -> render('/site/dental/dental8-preview',['dataProvider' => $dataProvider,'names' => $names,'sText' => $this->sText,
                                    'mText' => $this->mText,'date1'=>$date1,'date2'=>$date2]);           
    }    
    ...
    public function actionDental14_preview($name,$d1,$d2,$t) {
        ...
        return $this->render('/site/dental/dental17-index',['mText'=>$this->mText,'names'=>$names,
