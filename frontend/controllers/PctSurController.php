...
class PctSurController extends Controller
{
    ...
    public $sText = "PCT ศัลยกรรมทั่วไป";    
    public $kText = "บริการข้อมูล";
    ...
    public function actionIndex1() {
        $model = new Formmodel();        
        $names="  Acute appendicitis(K35-K389) "; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
            return $this->redirect(['sur1_preview','name'=>$names,'d1'=>$date1,'d2'=>$date2]);
        }        
        return $this->render('/site/pct-sur/sur1-index',['names'=>$names,'mText'=>$this->mText, 'sText' =>$this->sText, 'model' => $model]);
    }
    ...
    public function actionIndex2() {
        $model = new Formmodel();        
        $names="  โรค Ugih(K922-K929)"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
            return $this->redirect(['sur2_preview','name'=>$names,'d1'=>$date1,'d2'=>$date2]);
        }        
        return $this->render('/site/pct-sur/sur2-index',['names'=>$names,'mText'=>$this->mText,  'sText' => $this->sText, 'model' => $model]);
    }
    ...
    public function actionIndex3() {
        $model = new Formmodel();        
        $names="  Necrotizing Fasciitis(M72-M726)"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
            return $this->redirect(['sur3_preview','name'=>$names,'d1'=>$date1,'d2'=>$date2]);
        }        
        return $this->render('/site/pct-sur/sur3-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model]);
    }    
   public function actionSur3_preview($name,$d1,$d2) {
    ...
    public function actionIndex4() {
        $model = new Formmodel();        
        $names="  Head injury(S00-S09)"; 
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
            return $this->redirect(['sur4_preview','name'=>$names,'d1'=>$date1,'d2'=>$date2]);
        }        
        return $this->render('/site/pct-sur/sur4-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model]);
    } 
   public function actionSur4_preview($name,$d1,$d2) {
    ...
    public function actionIndex5() {
        ...
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=pct-sur/";   
               return $this->redirect($url.'sur5.mrt&d1='.$date1.'&d2='.$date2);                
        }        
        return $this->render('/site/pct-sur/sur5-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model]);
    }    
    public function actionIndex6() {
        ...
        if($model->load(Yii::$app->request->post())){
               ...
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=pct-sur/";   
               return $this->redirect($url.'sur6.mrt&d1='.$date1.'&d2='.$date2);                
        }        
        return $this->render('/site/pct-sur/sur5-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model]);
    }     
    ...
    public function actionKpi61Index1() {
        $model = new Formmodel();        
        $names="รายงานอัตราการเสียชีวิตของผู้ป่วยศัลยกรรมทั่วไป (ผู้รับผิดชอบ-ER,OR,ICU,Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=pct-sur/";   
        ...
        return $this->render('/site/pct-sur/kpi61-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model, 'kText'=>$this->kText,'pname'=>$pname]);
    }     
    public function actionKpi61Index2() {
        $model = new Formmodel();        
        $names="รายงานอัตราการตายจากการผ่าตัดภายใน 48 ชม. (ผู้รับผิดชอบ-OR,ICU,Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index3() {
        $model = new Formmodel();        
        $names="รายงานอัตราการผ่าตัดซ้ำภายใน 24 ชม. (ผู้รับผิดชอบ-OR,ICU,Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index4() {
        $model = new Formmodel();        
        $names="รายงานอัตราการติดเชื้อแผลผ่าตัด(Appendectomy) (ผู้รับผิดชอบ-OPD sx,Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index5() {
        $model = new Formmodel();        
        $names="รายงานอัตราการติดเชื้อแผลผ่าตัด(Hernia) (ผู้รับผิดชอบ-OPD sx,Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index6() {
        $model = new Formmodel();        
        $names="รายงานอัตราการ Re-admit ภายใน 28 วัน (ผู้รับผิดชอบ-Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index7() {
        $model = new Formmodel();        
        $names="รายงานอัตราการ Re-admit ภายใน 28 วัน  ของผู้ป่วย UGIB (ผู้รับผิดชอบ-Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index8() {
        $model = new Formmodel();        
        $names="รายงานอัตราการ Re-admit ภายใน 28 วัน ของผู้ป่วย NF (ผู้รับผิดชอบ-Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index9() {
        $model = new Formmodel();        
        $names="รายงานอัตราตายในผู้ป่วย UGIB (ผู้รับผิดชอบ-Ward,ICU)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index10() {
        $model = new Formmodel();        
        $names="รายงานอัตราตายในผู้ป่วย NF (ผู้รับผิดชอบ-Ward,ICU)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
    ...
    public function actionKpi61Index11() {
        $model = new Formmodel();        
        $names="รายงานอัตราการเกิด rupture appendicitis (ผู้รับผิดชอบ-OR)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=pct-sur/";   
               return $this->redirect($url.'kpi61_11.mrt&d1='.$date1.'&d2='.$date2);                
        }        
        return $this->render('/site/pct-sur/kpi61-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model, 'kText'=>$this->kText,'pname'=>$pname]);
    }    
    public function actionKpi61Index12() {
        $model = new Formmodel();        
        $names="รายงานอัตราการนอนโรงพยาบาลของผู้ป่วย Non-rupture appendicitis ภายใน 3 วัน (ผู้รับผิดชอบ-Ward)"; 
        $pname="รายงานตัวชีวัดปีงบประมาณ 2561";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=pct-sur/";   
               return $this->redirect($url.'kpi61_12.mrt&d1='.$date1.'&d2='.$date2);                
        }        
        return $this->render('/site/pct-sur/kpi61-index',['names'=>$names,'mText'=>$this->mText, 'sText' => $this->sText, 'model' => $model, 'kText'=>$this->kText,'pname'=>$pname]);
    }    
