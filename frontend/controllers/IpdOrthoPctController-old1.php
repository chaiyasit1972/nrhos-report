...
class IpdOrthoPctController extends Controller
{
   ...
   public function actionPct8_preview($name, $d1, $d2) {
       ...
       try {
        ...
        $sql5 = "select a.hn,a.an,concat(p.pname,p.fname,' ',p.lname) pname,a.age_y,a.regdate,ip.regtime,a.dchdate,
                    a.pdx,i.name diag , w.`name` ward, a.op0,a.op1, a.op2, a.op3, a.op4, a.op5, a.op6,
                    ic.name icd9n,o.request_date, o.request_time,o.operation_name, d.name statusx
                    from an_stat a 
                    inner join patient p on p.hn=a.hn
                    inner join icd101 i on a.pdx=i.code 
