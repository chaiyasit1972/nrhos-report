...
class KidneyController extends Controller
{
    ...
    public function actionIndex() {
        $names="รายงานคลินิกโรคไต(N17-N19)"; 
         return $this -> render('/site/kidney/index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names]);
    } 
    public function actionKidney1Index(){
       ...
       try {
        ...
        return $this->render('/site/kidney/kidney1-preview',['names'=>$names,'mText'=>$this->mText,'sText'=>$this->sText,
    ...
    public function actionKidney2Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/kidney/kidney2-index',['mText'=>$this->mText,'sText'=>$this->sText,
    ...
    public function actionKidney3Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/kidney/kidney3-index',['mText'=>$this->mText,'sText'=>$this->sText,
                                         'names'=>$names, 'model'=>$model]);
    }       
    public function actionKidney3_preview($d1,$d2) {
        ...
        return $this -> render('/site/kidney/kidney3-preview',['dataProvider' => $dataProvider,'names' => $names,'sText'=>$this->sText,
