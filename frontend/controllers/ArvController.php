...
class ArvController extends Controller
{
    ...
    public function actionIndex() {
        $names="งานคลินิกยาต้านผู้ป่วยโรคเรื้อรัง(ARV)"; 
         return $this -> render('/site/arv/index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names]);
    } 
     public function actionArv0Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv0-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}    
     public function actionArv1Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv1-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv2Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv2-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv3Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv3-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv4Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv4-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv5Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv5-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv6Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv6-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv7Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv7-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv8Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv8-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv9Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv9-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv10Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv10-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv11Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv11-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv12Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv12-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv13Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv13-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv14Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv14-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv15Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv15-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
}
     public function actionArv16Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv16-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
     }
     public function actionArv17Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/arv/arv17-index',['mText'=>$this->mText,'names'=>$names,'sText'=>$this->sText,
                                             'model' => $model, 'data'=>$listData]);
     }     
     public function actionArv18Index() {
        $names=" รายงานผู้ป่วยคลินิก ARV";
        $model = new Formmodel();
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=arv/";   
               return $this->redirect($url.'arv18.mrt&d1='.$date1);                       
        }
            return $this -> render('/site/arv/arv18-index',['mText'=>$this->mText,'sText'=>$this->sText,'names'=>$names,'model' => $model]);
     }     
}    