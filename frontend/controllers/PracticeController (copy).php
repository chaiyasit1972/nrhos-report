...
class PracticeController extends Controller
{
    ...
    public function actionIndex() {
        $names="งานเวชปฎิบัติชุมชนและครอบครัว"; 
         return $this -> render('/site/practice/index',['mText'=>$this->mText, 'sText' => $this->sText, 'names'=>$names]);
    } 
    ...
    public function actionPractice1_preview($name,$d1,$d2,$t1,$v1) {
        ...
        return $this -> render('/site/practice/practice1-preview',['dataProvider' => $dataProvider,'names' => $names,
                                    'mText' => $this->mText,'sText' => $this->sText,'date1'=>$date1,'date2'=>$date2,'type_n'=>$type_n,
    ...
    public function actionPractice2Index()
    {
        ...
        if($model->load(Yii::$app->request->post())){
         ...
         return $this->render('/site/practice/practice2-index',['mText' => $this->mText, 'sText' => $this->sText,'names' => $names, 'model' => $model]);       
    } 
    public function actionPractice2_preview($name,$d1,$d2) {
        ...
        $sql1="select count(*) cc from person where house_regist_type_id in ('1','3') and age_y >= 60 
                  and village_id !='9' and death !='Y';";
        ...
        return $this->render('/site/practice/practice2-preview',['mText'=>$this->mText,'names'=>$names,'sText' => $this->sText,
    ...
    public function actionPractice3Index()
    {
        ...
        if($model->load(Yii::$app->request->post())){
         ...
         return $this->render('/site/practice/practice3-index',['mText' => $this->mText,'sText' => $this->sText,'names' => $names, 'model' => $model]);       
    }
	...
	$sql20 = "select count(*) num from depression_screen dp left outer join patient_depression pd on dp.patient_depression_id=pd.patient_depression_id
        ...
        return $this->render('/site/practice/practice3-preview',['mText'=>$this->mText,'names'=>$names,'sText' => $this->sText,
                 'dataProvider'=>$dataProvider, 'date1' =>$date1,'date2' =>$date2]);              
    }   
    public function actionPractice4Index()
    {
        ...
        if($model->load(Yii::$app->request->post())){
         ...
         return $this->render('/site/practice/practice4-index',['mText' => $this->mText,'sText' => $this->sText, 'names' => $names, 'model' => $model]);       
    }    
    public function actionPractice4_preview($name,$d1,$d2) {
        ...
        return $this -> render('/site/practice/practice4-preview',['dataProvider' => $dataProvider,'names' => $names,
                                    'mText' => $this->mText,'sText' => $this->sText,'date1'=>$date1,'date2'=>$date2]);                       
    }    
    public function actionPractice5Index()
    {
        ...
        if($model->load(Yii::$app->request->post())){
         ...
         return $this->render('/site/practice/practice5-index',['mText' => $this->mText, 'sText' => $this->sText, 'names' => $names, 'model' => $model]);       
    }    
    public function actionPractice5_preview($name,$d1,$d2) {
        ...
        return $this -> render('/site/practice/practice5-preview',['dataProvider' => $dataProvider,'names' => $names,
                                       'sText' => $this->sText,'mText' => $this->mText,'date1'=>$date1,'date2'=>$date2]);          
    }        
    public function actionPractice6Index()
    {
        ...
        if($model->load(Yii::$app->request->post())){
         ...
         return $this->render('/site/practice/practice6-index',['mText' => $this->mText,'sText' => $this->sText, 'names' => $names, 'model' => $model]);       
    }     
    ...
    public function actionPractice7_preview($name,$d1,$t1) {
        ...
        return $this -> render('/site/practice/practice7-preview',['dataProvider' => $dataProvider,'names' => $names,
                                      'sText' => $this->sText, 'mText' => $this->mText,'date1'=>$date1,'type_name'=>$type_name]);                           
    }    
    public function actionPractice8Index() {
        ...
        if($model->load(Yii::$app->request->post())){
            ...
            return $this -> render('/site/practice/practice8-index',['mText'=>$this->mText, 'sText' => $this->sText, 'names'=>$names, 'model' =>$model]);            
    }     
    public function actionPractice8_preview($name,$c,$d1,$d2) {
       ...
       try {
        ...
        return $this -> render('/site/practice/practice8-preview',['dataProvider' => $dataProvider, 'names' => $names,
                                       'sText' => $this->sText, 'mText' => $this->mText, 'text' => $text]);           
    }        
    public function actionPractice9Index() {
        ...
        return $this -> render('/site/practice/practice9-index',['mText'=>$this->mText, 'sText' => $this->sText, 'names'=>$names, 'model' =>$model]);            
    }        
    public function actionPractice10Index() {
        ...
        return $this -> render('/site/practice/practice10-index',['mText'=>$this->mText, 'sText' => $this->sText, 'names'=>$names,
    ...
    public function actionPractice11Index() {
        ...
        return $this -> render('/site/practice/practice11-index',['mText'=>$this->mText, 'sText' => $this->sText, 'names'=>$names,'model' =>$model]);            
    }     
    public function actionPractice12Index()
    {
        ...
        if($model->load(Yii::$app->request->post())){
         ...
         return $this->render('/site/practice/practice12-index',['mText' => $this->mText, 'sText' => $this->sText,
    ...
    public function actionPractice12_preview($name, $d1, $t, $v1) {
       ...
       try {
        ...
        return $this -> render('/site/practice/practice12-preview',['dataProvider' => $dataProvider, 'names' => $names,
                                       'sText' => $this->sText, 'mText' => $this->mText, 'moo' => $village_name, 'type' => $type_n]);            
    }        
    public function actionPractice13Index() {
        $model = new Formmodel();
        $names=" รายงานการคัดกรอง PP-SPECIAL";
        if($model->load(Yii::$app->request->post())){
               $date1 = $model->date1;
               $date2 = $model->date2;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=Practice/";
                return $this->redirect($url.'Practice13.mrt&d1='.$date1.'&d2='.$date2);                  
        }
        return $this -> render('/site/practice/practice13-index',['mText'=>$this->mText, 'sText' => $this->sText, 'names'=>$names, 'model' =>$model]);            
    }      
    public function actionPractice14Index() {
        $model = new Formmodel();
        $names="รายงานบัญชี 5 รร.ราชประชานุเคราะห์51(โครงการในพระราชดำริ)";
        $sql = "select village_school_class_id as id, village_school_class_name names from village_school_class order by village_school_class_id";
        ...
        if($model->load(Yii::$app->request->post())){
               ...
               $class = $model->select1;
               $url="http://192.168.3.8/stimulrep/stimulsoft/index.php?stimulsoft_client_key=ViewerFx&stimulsoft_report_key=Practice/";
                return $this->redirect($url.'Practice14.mrt&d1='.$date1.'&d2='.$date2.'&cl='.$class);                  
        }
        return $this -> render('/site/practice/practice14-index',['mText'=>$this->mText, 'names'=>$names,
                                       'sText' => $this->sText,'model' =>$model, 'data'=>$listData]);            
    }       
}    
