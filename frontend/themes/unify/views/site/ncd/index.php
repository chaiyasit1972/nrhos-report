                          ...
                          <a class="btn-u btn-u-green" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          19. รายงานผู้ป่วยเบาหวานที่ได้รับยาฉีด ',
                                                          ['/ncd-clinic2/clinic19-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          19. รายงานผู้ป่วยเบาหวานที่ได้รับยาฉีด ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          20. รายงานรายละเอีดตัวชี้วัดกระทรวง(แยกปีงบประมาณ) ',
                                                          ['/ncd-clinic2/kpi-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          20. รายงานรายละเอีดตัวชี้วัดกระทรวง(แยกปีงบประมาณ) ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          21. รายงานผู้ป่วยโรคเรื้อรัง( DM,HT ) ที่ยังไม่ได้ลงทะเบียนในบัญชี 1 ',
                                                          ['/ncd-clinic2/clinic20-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          21. รายงานผู้ป่วยโรคเรื้อรัง( DM,HT ) ที่ยังไม่ได้ลงทะเบียนในบัญชี 1 ',
                                                          ['site/modal'],
                                                          [
