                           ...
                           <label class="label">   
                                <?php
                                            echo Select2::widget([
                                                'name' => 'type',
                                                'data' => [
                                                    '1,เบาหวาน(อย่างเดียว)' => 'เบาหวาน(อย่างเดียว)',
                                                    '2,ความดันโลหิตสูง(อย่างเดียว)' => 'ความดันโลหิตสูง(อย่างเดียว)',
                                                    '3,เบาหวานและความดันโลหิตสูง' => 'เบาหวานและความดันโลหิตสูง',
                                                ],
                                                'size' => Select2::SMALL,
                                                'theme' => 'krajee',
                                                'options' => ['placeholder' => '========== ภาวะผู้ป่วย =========='],
                                                'pluginOptions' => [
                                                    'allowClear' => true
                                                ],
                                            ]);
