...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=Html::a($mText,['/asthma/index']);;?></li>
        </ul>
    </div>
</div>
       ...
       <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?= $baseUrl ?>/assets/img/asthma1.jpg" alt="">
                </div>         
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/asthma2.jpg" alt="">
                </div> 
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานทะเบียนผู้ป่วยคลินิก Asthma',
                                                          ['/asthma/asthma1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานทะเบียนผู้ป่วยคลินิก Asthma',
                                                          ['site/modal'],
                                                          [
