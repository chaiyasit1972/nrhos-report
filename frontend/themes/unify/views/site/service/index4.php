                    ...
                    <ul id="collapse6" class="collapse">
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.2 &nbsp; รายงาน 10 อันดับโรคผู้ป่วยทางตา ผู้ป่วยนอก(ICD10 H00-H59,Z010)', 
                                                          ['pct-opt/index2']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.2 &nbsp; รายงาน 10 อันดับโรคผู้ป่วยทางตา ผู้ป่วยนอก(ICD10 H00-H59,Z010)', 
                                                          ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.3 &nbsp; รายงาน 10 อันดับโรคผู้ป่วยทางตา ผู้ป่วยใน(ICD10 H00-H59)', 
                                                          ['pct-opt/index3']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.3 &nbsp; รายงาน 10 อันดับโรคผู้ป่วยทางตา ผู้ป่วยใน(ICD10 H00-H59)', 
                                                          ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.4 &nbsp; รายงานโรคทางตา ผู้ป่วยใน(ICD10 H00-H59) Refer', 
                                                          ['pct-opt/index4']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.4 &nbsp; รายงานโรคทางตา ผู้ป่วยใน(ICD10 H00-H59) Refer', 
                                                          ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.5 &nbsp; รายงานโรคทางตาผู้ป่วยใน(ICD10 H00-H59) Readmit 28 วัน', 
                                                          ['pct-opt/index5']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.5 &nbsp; รายงานโรคทางตาผู้ป่วยใน(ICD10 H00-H59) Readmit 28 วัน', 
                                                          ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.6 &nbsp; รายงานการประเมิน VA ผู้ป่วยโรคทางตาผู้ป่วยใน(ICD9 13.7)', 
                                                          ['pct-opt/index6']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.6 &nbsp; รายงานการประเมิน VA ผู้ป่วยโรคทางตาผู้ป่วยใน(ICD9 13.7)', 
                                                          ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.7 &nbsp; รายงานการคัดกรองต้อกระจก(ICD10 Z010) และให้บริการตามนัด', 
                                                          ['pct-opt/index7']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6.7 &nbsp; รายงานการคัดกรองต้อกระจก(ICD10 Z010) และให้บริการตามนัด', 
                                                          ['site/modal'], [
                    ...
                    <ul id="collapse7" class="collapse">
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.2 &nbsp; <span> รายงาน 10 อันดับโรค(EENT) ผู้ป่วยนอก ICD10 H60-H95,Z011</span>', 
                                                   ['pct-eent/index2']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.2 &nbsp; <span> รายงาน 10 อันดับโรค(EENT) ผู้ป่วยนอก ICD10 H60-H95,Z011</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.3 &nbsp; <span> รายงาน 10 อันดับโรค(EENT) ผู้ป่วยใน ICD10 H60-H95</span>', 
                                                   ['pct-eent/index3']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.3 &nbsp; <span> รายงาน 10 อันดับโรค(EENT) ผู้ป่วยใน ICD10 H60-H95</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.4 &nbsp; <span> รายงานจำนวนผู้ป่วยด้วยโรค Epistaxis (R040) ผู้ป่วยใน</span>', 
                                                   ['pct-eent/index4']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.4 &nbsp; <span> รายงานจำนวนผู้ป่วยด้วยโรค Epistaxis (R040) ผู้ป่วยใน</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.5 &nbsp; <span> รายงานจำนวนผู้ป่วยด้วยโรค Tonsillectomy (Icd9 280-289) ผู้ป่วยใน</span>', 
                                                   ['pct-eent/index5']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.5 &nbsp; <span> รายงานจำนวนผู้ป่วยด้วยโรค Tonsillectomy (Icd9 280-289) ผู้ป่วยใน</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.6 &nbsp; <span> รายงานจำนวนผู้ป่วย(EENT) refer ผู้ป่วยนอก ICD10 H60-H95</span>', 
                                                   ['pct-eent/index6']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.6 &nbsp; <span> รายงานจำนวนผู้ป่วย(EENT) refer ผู้ป่วยนอก ICD10 H60-H95</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.7 &nbsp; <span> รายงานจำนวนผู้ป่วย(EENT) refer ผู้ป่วยใน ICD10 H60-H95</span>', 
                                                   ['pct-eent/index7']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.7 &nbsp; <span> รายงานจำนวนผู้ป่วย(EENT) refer ผู้ป่วยใน ICD10 H60-H95</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.8 &nbsp; <span> รายงานรายชื่อผู้ป่วย(EENT) Readmit 28 วัน ICD10 H60-H95</span>', 
                                                   ['pct-eent/index8']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.8 &nbsp; <span> รายงานรายชื่อผู้ป่วย(EENT) Readmit 28 วัน ICD10 H60-H95</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.9 &nbsp; <span> รายงานจำนวนผู้ป่วย(EENT) Thyroidectomy ICD9 060-069</span>', 
                                                   ['pct-eent/index9']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.9 &nbsp; <span> รายงานจำนวนผู้ป่วย(EENT) Thyroidectomy ICD9 060-069</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.10 &nbsp; <span> รายงานจำนวนผู้ป่วยกลุ่มโรค Airway Obstruction (ICD10 K122)</span>', 
                                                   ['pct-eent/index10']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.10 &nbsp; <span> รายงานจำนวนผู้ป่วยกลุ่มโรค Airway Obstruction (ICD10 K122)</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.11 &nbsp; <span> รายงานจำนวนผู้ป่วยกลุ่มโรค Airway Obstruction (ICD10 L024,L020)</span>', 
                                                   ['pct-eent/index11']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.11 &nbsp; <span> รายงานจำนวนผู้ป่วยกลุ่มโรค Airway Obstruction (ICD10 L024,L020)</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.12 &nbsp; <span> รายงานจำนวนผู้ป่วยกลุ่มโรค Airway Obstruction (ICD10 K140)</span>', 
                                                   ['pct-eent/index12']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.12 &nbsp; <span> รายงานจำนวนผู้ป่วยกลุ่มโรค Airway Obstruction (ICD10 K140)</span>', 
                                                   ['site/modal'], [
                        ...
                        <li>
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.13 &nbsp; <span> รายงานจำนวนผู้ป่วยกลุ่มโรค Airway Obstruction (ICD10 J988)</span>', 
                                                   ['pct-eent/index13']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                   7.13 &nbsp; <span> รายงานจำนวนผู้ป่วยกลุ่มโรค Airway Obstruction (ICD10 J988)</span>', 
                                                   ['site/modal'], [
