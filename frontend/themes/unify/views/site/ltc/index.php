...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=Html::a($sText,['/ltc/index']);;?></li>
            <li><?=Html::a($names,['/ltc/index']);;?></li>            
        </ul>
    </div>
</div>
                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 ...
                                 <li>
                                    <?=  !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          14. รายงานรายชื่อผู้ป่วยตามรหัสโรค(ICD-10) แยกตามหมู่บ้าน/ชุมชน',
                                                          ['/ltc/ltc14-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          14. รายงานรายชื่อผู้ป่วยตามรหัสโรค(ICD-10) แยกตามหมู่บ้าน/ชุมชน',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?=  !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          15. รายงานจำนวนผู้ป่วยตามรหัสโรค(ICD-10 : Z508,Z74) แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['/ltc/ltc15-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          15. รายงานรายชื่อผู้ป่วยตามรหัสโรค(ICD-10 : Z508,Z74) แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['site/modal'],
                                                          [
                                                                 'class' => 'xmodal',
                                                                 'title' => 'เปิดดูข้อมูล',
                                 ...
                                 <li>
                                    <?=  !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          16. รายงานจำนวนผู้พิการที่ได้รับการจดทะเบียน แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['/ltc/ltc16-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          16. รายงานจำนวนผู้พิการที่ได้รับการจดทะเบียน แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?=  !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          17. รายงานจำนวนผู้พิการแยกตามกลุ่มความพิการ แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['/ltc/ltc17-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          17. รายงานจำนวนผู้พิการแยกตามกลุ่มความพิการ แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?=  !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          18. รายงานจำนวนผู้พิการได้รับการดูแลเยี่ยมบ้าน แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['/ltc/ltc18-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          18. รายงานจำนวนผู้พิการได้รับการดูแลเยี่ยมบ้าน แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?=  !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          19. รายงานจำนวนผู้พิการตามสิทธิการรักษาพยาบาล แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['/ltc/ltc19-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          19. รายงานจำนวนผู้พิการตามสิทธิการรักษาพยาบาล แยกในเขต/นอกเขต รับผิดชอบ',
                                                          ['site/modal'],
