...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=Html::a($mText,['/ipd-child/index']);;?></li>
        </ul>
    </div>
</div>
                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานอัตราป่วยตายด้วยโรคปอดบวม ในเด็กอายุ 1 เดือน ถึง 5 ปี',
                                                          ['/ipd-child/child1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานอัตราป่วยตายด้วยโรคปอดบวม ในเด็กอายุ 1 เดือน ถึง 5 ปี',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานอัตราผู้ป่วย(IPD)ไข้เลือดออกที่มีภาวะแทรกซ้อน(แยกตามกลุ่มอายุ)',
                                                          ['/ipd-child/child2-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานอัตราผู้ป่วย(IPD)ไข้เลือดออกที่มีภาวะแทรกซ้อน(แยกตามกลุ่มอายุ)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงาน 20 อันดับโรคแรกผู้ป่วยใน ตึกสกลฯชั้น 2 (กุมารเวชกรรม)',
                                                          ['/ipd-child/child3-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงาน 20 อันดับโรคแรกผู้ป่วยใน ตึกสกลฯชั้น 2 (กุมารเวชกรรม)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานจำนวนผู้ป่วยใน ตึกสกลฯชั้น 2 (กุมารเวชกรรม) ห้องพิเศษ แยกสิทธิ์การรักษา',
                                                          ['/ipd-child/child4-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานจำนวนผู้ป่วยใน ตึกสกลฯชั้น 2 (กุมารเวชกรรม) ห้องพิเศษ แยกสิทธิ์การรักษา',
                                                          ['site/modal'],
                                                          [
