                          ...
                          <a class="btn-u btn-u-green" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 ...
                                 <li>
                                    <?=!Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานอัตราตายจากมะเร็งตับ',
                                                          ['/ipd-cancer/cancer5-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานอัตราตายจากมะเร็งตับ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?=!Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6. รายงานอัตราตายจากมะเร็งปอด',
                                                          ['/ipd-cancer/cancer6-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6. รายงานอัตราตายจากมะเร็งปอด',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?=!Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          7. รายงานภาวะแทรกซ้อน โรคร่วม(D70)',
                                                          ['/ipd-cancer/cancer7-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          7. รายงานภาวะแทรกซ้อน โรคร่วม(D70)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?=!Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          8. รายงานภาวะแทรกซ้อน โรคร่วม(D70 และ R509)',
                                                          ['/ipd-cancer/cancer8-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          8. รายงานภาวะแทรกซ้อน โรคร่วม(D70 และ R509)',
                                                          ['site/modal'],
                                                          [
