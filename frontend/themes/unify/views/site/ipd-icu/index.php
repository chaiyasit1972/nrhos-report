       ...
       <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?= $baseUrl ?>/assets/img/icu3.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/icu2.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/icu1.jpg" alt="">
                </div>          
            </div>
                          ...
                          <a class="btn-u btn-u-green" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app -> user ->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานข้อมูลผู้ป่วยใน(sepsis,sepsis shock)  ',
                                                          ['/ipd-icu/icu1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานข้อมูลผู้ป่วยใน(sepsis,sepsis shock)  ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานโรคหลักของภาวะ(sepsis shock (R572))  ',
                                                          ['/ipd-icu/icu2-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานโรคหลักของภาวะ(sepsis shock (R572))  ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานจำนวนผู้เสียชีวิตด้วยโรคหลัก(Priciple Dx Icd-10 A00-A419,R651,R572)  ',
                                                          ['/ipd-icu/icu3-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานจำนวนผู้เสียชีวิตด้วยโรคหลัก(Priciple Dx Icd-10 A00-A419,R651,R572)  ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานจำนวนผู้ป่วย Admit และ ผู้เสียชีวิตด้วยโรค Leptospirosis (Priciple Dx Icd-10 A27,A270,A278,A279)  ',
                                                          ['/ipd-icu/icu4-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานจำนวนผู้ป่วย Admit และ ผู้เสียชีวิตด้วยโรค Leptospirosis (Priciple Dx Icd-10 A27,A270,A278,A279)  ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานจำนวนผู้ป่วย Admit และ ผู้เสียชีวิตด้วยโรค Gastroenteritis (Priciple Dx Icd-10 A09,A090,A099)  ',
                                                          ['/ipd-icu/icu5-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานจำนวนผู้ป่วย Admit และ ผู้เสียชีวิตด้วยโรค Gastroenteritis (Priciple Dx Icd-10 A09,A090,A099)  ',
                                                          ['site/modal'],
