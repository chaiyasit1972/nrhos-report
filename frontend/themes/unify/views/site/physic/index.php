    ...
    <div class="col-md-4">
       <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                ...
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/anc3.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/anc1.jpg" alt="">
                </div>          
            </div>
                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงาน Brain Dysfunction Traumatic [Traumatic Unspecified, Open Injury, Closed Injury] ทั้งหมด ',
                                                          ['/physic/index1']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงาน Brain Dysfunction Traumatic [Traumatic Unspecified, Open Injury, Closed Injury] ทั้งหมด ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงาน Traumatic Spinal Cord Dysfunction ทั้งหมด ',
                                                          ['/physic/index2']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงาน Traumatic Spinal Cord Dysfunction ทั้งหมด ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงาน Major Multiple Trauma [Brain + Spinal Cord Injury] ทั้งหมด ',
                                                          ['/physic/index3']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงาน Major Multiple Trauma [Brain + Spinal Cord Injury] ทั้งหมด ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานผลการปฎิบัติงานและค่าใช้จ่ายเวชศาสตร์ฟื้นฟูแยกตามกลุ่มโรค',
                                                          ['/physic/index4']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานผลการปฎิบัติงานและค่าใช้จ่ายเวชศาสตร์ฟื้นฟูแยกตามกลุ่มโรค',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงาน 5 อันดับโรคเวชศาสตร์ฟื้นฟูแยกตามกลุ่มโรค',
                                                          ['/physic/index5']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงาน 5 อันดับโรคเวชศาสตร์ฟื้นฟูแยกตามกลุ่มโรค',
                                                          ['site/modal'],
