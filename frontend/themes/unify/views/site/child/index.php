...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=Html::a($sText,['#']);?></li>
            <li><?=Html::a($mText,['/child/index']);;?></li>
        </ul>
    </div>
</div>
       ...
       <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?= $baseUrl ?>/assets/img/child2.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/child1.jpg" alt="">
                </div>          
            </div>
...
?> 
 <?php
        ...
        Modal::end();
 ?>     
<div class="margin-bottom-100"></div>&nbsp;<div class="margin-bottom-100"></div>