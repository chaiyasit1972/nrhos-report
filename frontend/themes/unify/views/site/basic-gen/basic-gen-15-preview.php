...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?= Html::a($mText, ['/gen/index']); ?></li>
            <li class="active"><?=Html::a($names, ['/basic-gen/basic-gen15']); ?></li>
        </ul>
    </div>
</div>
<div class="page-content margin-left-10 margin-right-10">
<?php
        $gridColumns = [
            [
            ...
            [ 
                'headerOptions' => ['style'=>'text-align:center'],      
                'attribute'=>'price',
                'label'=>'ค่าใช้จ่ายทั้งหมด(เฉพาะหัตถการ)',
                'vAlign'=>'middle',
                'hAlign'=>'center',
                'format'=>['decimal',2],       
            ],  
...
echo GridView::widget([
        'dataProvider' => $dataProvider,
        'columns' => $gridColumns, 
        'tableOptions' =>['class'=>'table table-striped table-bordered table-hoverr service-info'],   
