...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=
                Html::a($mText, ['/gen/index']);
                ?></li>
            <li class="active"><?= Html::a($names, ['/basic-gen/basic-gen9']);?></li>
        </ul>
    </div>
</div>
...
<div class="col-md-5">    
<div id="chart1" class="box box-default col-md-12 margin-left-5 margin-right-5">
<?php
$this->registerJs("$(function () {
    $('#chart1').highcharts({
        ...
        title: {
            text: 'รายงาน 5 อันดับโรคการส่งต่อผู้ป่วยนอก(ยกเว้น งานส่งเสริมสุขภาพ)'
        },
        xAxis: {
            type: 'category'
        },
