                ...
                <li class="list-group-item list-toggle">
                    ...
                    <ul id="collapse1" class="collapse">
                            ...
                            <?=
                                    !Yii::$app->user->isGuest ?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                                 1 &nbsp;   Closed Fracture', ['pct-ortho/index1']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                                 1 &nbsp;   Closed Fracture', ['site/modal'], [
                                                'class' => 'xmodal',
                                                'title' => 'เปิดดูข้อมูล',
                                                'data-target' => '#vmodal',
                                                'data-pjax' => '0',
                        ...
                        <li>
                            <?= !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            2. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยรับส่งต่อ (Refer In)',
                                            ['pct-ortho/index2']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            2. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยรับส่งต่อ (Refer In)',
                                            ['site/modal'], [
                        ...
                        <li>
                            <?= !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            3. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยส่งต่อ (Refer Out)',
                                            ['pct-ortho/index3']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            3. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยส่งต่อ (Refer Out)',
                                            ['site/modal'], [
