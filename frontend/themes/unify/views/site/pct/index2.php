                ...
                <li class="list-group-item list-toggle">
                    ...
                    <ul id="collapse1" class="collapse">
                        <li>
                            ...
                            !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         1 &nbsp;  Acute appendicitis(K35-K389)', ['pct-sur/index1']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         1 &nbsp;  Acute appendicitis(K35-K389)', ['site/modal'], [
                                        'class' => 'xmodal',
                                        'title' => 'เปิดดูข้อมูล',
                                        'data-target' => '#vmodal',
                                        'data-pjax' => '0',
                        ...
                        <li>
                            ...
                            !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         2 &nbsp;  โรค Ugih(K922-K929) ', ['pct-sur/index2']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         2 &nbsp; โรค Ugih(K922-K929) ', ['site/modal'], [
                                        'class' => 'xmodal',
                                        'title' => 'เปิดดูข้อมูล',
                                        'data-target' => '#vmodal',
                                        'data-pjax' => '0',
                        ...
                        <li>
                            ...
                            !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         3 &nbsp;  Necrotizing Fasciitis', ['pct-sur/index3']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         3 &nbsp;  Necrotizing Fasciitis', ['site/modal'], [
                                        'class' => 'xmodal',
                                        'title' => 'เปิดดูข้อมูล',
                                        'data-target' => '#vmodal',
                                        'data-pjax' => '0',
                        ...
                        <li>
                            ...
                            !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         4 &nbsp;  Head injury(S00-S09)', ['pct-sur/index4']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         4 &nbsp;  Head injury(S00-S09)', ['site/modal'], [
                                        'class' => 'xmodal',
                                        'title' => 'เปิดดูข้อมูล',
                                        'data-target' => '#vmodal',
                                        'data-pjax' => '0',
                        ...
                        <li>
                            <?= !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            5. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยรับส่งต่อ (Refer In)',
                                            ['pct-sur/index5']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            5. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยรับส่งต่อ (Refer In)',
                                            ['site/modal'], [
                        ...
                        <li>
                            <?= !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            6. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยส่งต่อ (Refer Out)',
                                            ['pct-sur/index6']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            6. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยส่งต่อ (Refer Out)',
                                            ['site/modal'], [
