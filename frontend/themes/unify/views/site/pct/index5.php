                ...
                <li class="list-group-item list-toggle">
                    ...
                    <ul id="collapse1" class="collapse">
                        <li>
                            ...
                            !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         1 &nbsp; DHF(A91/A91) ', ['pct-child/index1']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         1 &nbsp; DHF(A91/A91) ', ['site/modal'], [
                                        'class' => 'xmodal',
                                        'title' => 'เปิดดูข้อมูล',
                                        'data-target' => '#vmodal',
                                        'data-pjax' => '0',
                        ...
                        <li>
                            ...
                            !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         2 &nbsp; VLBW 0-999 กรัม', ['pct-child/index2']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         2 &nbsp; VLBW 0-999 กรัม', ['site/modal'], [
                                        'class' => 'xmodal',
                                        'title' => 'เปิดดูข้อมูล',
                                        'data-target' => '#vmodal',
                                        'data-pjax' => '0',
                        ...
                        <li>
                            ...
                            !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         3 &nbsp; VLBW 1000-1499 กรัม ', ['pct-child/index3']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         3 &nbsp; VLBW 1000-1499 กรัม ', ['site/modal'], [
                                        'class' => 'xmodal',
                                        'title' => 'เปิดดูข้อมูล',
                                        'data-target' => '#vmodal',
                                        'data-pjax' => '0',
                        ...
                        <li>
                            ...
                            !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         4 &nbsp; VLBW 1500-2499 กรัม', ['pct-child/index4']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                                         4 &nbsp; VLBW 1500-2499 กรัม', ['site/modal'], [
                                        'class' => 'xmodal',
                                        'title' => 'เปิดดูข้อมูล',
                                        'data-target' => '#vmodal',
                                        'data-pjax' => '0',
                        ...
                        <li>
                            <?= !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            6. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยรับส่งต่อ (Refer In)',
                                            ['pct-child/index6']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            6. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยรับส่งต่อ (Refer In)',
                                            ['site/modal'], [
                        ...
                        <li>
                            <?= !Yii::$app->user->isGuest ?
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            7. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยส่งต่อ (Refer Out)',
                                            ['pct-child/index7']) :
                                    Html::a('<i class="fa fa-arrow-right color-green"></i>
                                            7. &nbsp;  รายงาน 20 อันดับโรค ผู้ป่วยส่งต่อ (Refer Out)',
                                            ['site/modal'], [
