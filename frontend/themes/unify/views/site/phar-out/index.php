                          ...
                          <a class="btn-u btn-u-green" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          7. รายงานจำนวนใบสั่งยาผู้ป่วยนอก(OPD)',
                                                          ['/phar-out/phar-out7-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          7. รายงานจำนวนใบสั่งยาผู้ป่วยนอก(OPD)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          8. รายงานจำนวนผู้ป่วยใน( : วันนอน )',
                                                          ['/phar-out/phar-out8-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          8. รายงานจำนวนผู้ป่วยใน( : วันนอน )',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          9. รายงานจำนวนผู้ป่วยติดเชื้อเอชไอวีและผู้ป่วยเอดส์ (ICD-10 B20 - B24) มารับบริการ(OPD)',
                                                          ['/phar-out/phar-out9-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          9. รายงานจำนวนผู้ป่วยติดเชื้อเอชไอวีและผู้ป่วยเอดส์ (ICD-10 B20 - B24) มารับบริการ(OPD)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          10. รายงานจำนวนผู้ป่วยที่ได้รับยา Warfarin(OPD)',
                                                          ['/phar-out/phar-out10-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          10. รายงานจำนวนผู้ป่วยที่ได้รับยา Warfarin(OPD)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          11. รายงานจำนวนผู้รับบริการคลินิกเบาหวาน(OPD)',
                                                          ['/phar-out/phar-out11-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          11. รายงานจำนวนผู้รับบริการคลินิกเบาหวาน(OPD)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          12. รายงานจำนวนผู้ป่วย Asthma/Copd (ICD-10 J44 - J45) มารับบริการ(OPD)',
                                                          ['/phar-out/phar-out12-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          12. รายงานจำนวนผู้ป่วย Asthma/Copd (ICD-10 J44 - J45) มารับบริการ(OPD)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                      13. รายงานจำนวนผู้ป่วยวัณโรค (A150-A153,A154-A157,A160-A162,A169-A170,A180-A186,A190,B200) รับบริการ(OPD) แยกตามรายโรค',
                                                          ['/phar-out/phar-out13-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                      13. รายงานจำนวนผู้ป่วยวัณโรค (A150-A153,A154-A157,A160-A162,A169-A170,A180-A186,A190,B200) รับบริการ(OPD) แยกตามรายโรค',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          14. รายงานมูลค่ายาผู้ป่วยนอก-ผู้ป่วยใน',
                                                          ['/phar-out/phar-out14-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          14. รายงานมูลค่ายา แยกผู้ป่วยนอก-ผู้ป่วยใน',
                                                          ['site/modal'],
                                                          [
                                                                 'class' => 'xmodal',
                                                                 'title' => 'เปิดดูข้อมูล',
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          15. รายงานการใช้ยาแยกตามชื่อยา',
                                                          ['/phar-out/phar-out15-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          15. รายงานการใช้ยาแยกตามชื่อยา',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          16. รายงานอันดับการแพ้ยามากที่สุด 20 อันดับ เรียงจาก ยาและอาการที่แพ้',
                                                          ['/phar-out/phar-out16-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          16. รายงานอันดับการแพ้ยามากที่สุด 20 อันดับ เรียงจาก ยาและอาการที่แพ้',
                                                          ['site/modal'],
                                                          [
