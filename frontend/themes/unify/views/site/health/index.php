...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=Html::a($mText,['/health/index']);;?></li>
        </ul>
    </div>
</div>
        ...
        <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?= $baseUrl ?>/assets/img/hea1.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/hea2.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/hea3.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/hea4.jpg" alt="">
                </div>             
            </div>
                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานตัวชี้วัดงานแพทย์แผนไทย ',
                                                          ['/health/health1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานตัวชี้วัดงานแพทย์แผนไทย ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานปริมาณการใช้ยางานแพทย์แผนไทย ',
                                                          ['/health/health2-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานปริมาณการใช้ยางานแพทย์แผนไทย ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานกิจกรรม(หัตถการ)แพทย์แผนไทย แยกตามสิทธิ์การรักษา ',
                                                          ['/health/health3-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานกิจกรรม(หัตถการ)แพทย์แผนไทย แยกตามสิทธิ์การรักษา ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานแพทย์แผนไทย แยกตามกลุ่มโรค ',
                                                          ['/health/health4-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานแพทย์แผนไทย แยกตามกลุ่มโรค ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานแพทย์แผนไทย(เปรียบเทียบผู้รับบริการผู้ป่วยนอก)',
                                                          ['/health/health5-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานแพทย์แผนไทย(เปรียบเทียบผู้รับบริการผู้ป่วยนอก)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6. รายงานแพทย์แผนไทยแยกการนวดรักษาและการฝังเข็ม',
                                                          ['/health/health6-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6. รายงานแพทย์แผนไทยแยกการนวดรักษาและการฝังเข็ม',
                                                          ['site/modal'],
                                                          [
