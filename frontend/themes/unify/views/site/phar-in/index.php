...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?= $sText; ?></li>            
            <li><?=Html::a($mText,['/phar-in/index']);;?></li>
        </ul>
    </div>
</div>
                          ...
                          <a class="btn-u btn-u-green" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายชื่อผู้ป่วยใช้ยาวัณโรค(ผป.ใน)',
                                                          ['/phar-in/phar-in1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายชื่อผู้ป่วยใช้ยาวัณโรค(ผป.ใน)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานรายการยากลับบ้าน(Hme)มูลค่าสูง เฉพาะยาฉีด',
                                                          ['/phar-in/phar-in2-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานรายการยากลับบ้าน(Hme)มูลค่าสูง เฉพาะยาฉีด',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานการใช้ยาเบาหวานในผู้ป่วย Admit ',
                                                          ['/phar-in/phar-in3-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานการใช้ยาเบาหวานในผู้ป่วย Admit ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานยาราคาสูงแจ้งคลังยา',
                                                          ['/phar-in/phar-in4-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานยาราคาสูงแจ้งคลังยา',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานเฝ้าระวังการใช้ยาในผู้ป่วยที่มีภาวะไตบกพร่อง',
                                                          ['/phar-in/phar-in5-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานเฝ้าระวังการใช้ยาในผู้ป่วยที่มีภาวะไตบกพร่อง',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6. รายงานการใช้ยา Restricted Drug',
                                                          ['/phar-in/phar-in6-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6. รายงานการใช้ยา Restricted Drug',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          7. รายงานการเกิด Drug Interaction',
                                                          ['/phar-in/phar-in7-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          7. รายงานการเกิด Drug Interaction',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          8. รายงานผู้ป่วยในที่จำหน่ายด้วยโรคเรื้อรัง(DM,HT,CKD)',
                                                          ['/phar-in/phar-in8-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          8. รายงานผู้ป่วยในที่จำหน่ายด้วยโรคเรื้อรัง(DM,HT,CKD)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          9. รายงานผู้ป่วยในที่ได้รับยา Warfarin',
                                                          ['/phar-in/phar-in9-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          9. รายงานผู้ป่วยในที่ได้รับยา Warfarin',
                                                          ['site/modal'],
                                                          [
