...
<div class="container content">
    <div class="row">
        ...
        <div class="panel panel-success margin-bottom-5">            
            ...
            <div class="panel">
                <div class="panel-body"><div col col-md-1></div>
                    <div class="col col-md-6 text-right">
                        <div class="form-group has-success">
                            <label class="control-label" for="inputSuccess">วันที่รับบริการ <label>&nbsp;</label>:<label>&nbsp;</label>
                                    <?= DatePicker::widget([
                                                  'model' => $model,
                                                  'attribute' => 'date1',
                                                  'name' =>'date1', 
                    ...
                    <div class="col col-md-3 indent has-success">
                        <label class="select state-success control-label" for="inputSuccess"> 
                                <?php
                                echo Select2::widget([
                                    'model' => $model,
                                    'attribute' => 'select1',                                    
                                    ...
                                    'size' => Select2::SMALL,
                                    'theme' => 'krajee',
                                    'options' => ['placeholder' => '=========  เลือกชั้นเรียน =========', 'style' => 'width:200px;'],
                                    'pluginOptions' => [
                                        'allowClear' => true
                                    ],
                                ]);
