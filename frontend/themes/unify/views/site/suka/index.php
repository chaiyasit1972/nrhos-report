                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานจำนวนผู้ที่้สัมผัสเชื้อพิษสุนัขบ้าได้รับการฉีดวัคซีน PCEC ทั้งหมด ในเขตรับผิดชอบ',
                                                          ['/suka/suka3-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานจำนวนผู้ที่้สัมผัสเชื้อพิษสุนัขบ้าได้รับการฉีดวัคซีน PCEC ทั้งหมด ในเขตรับผิดชอบ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานจำนวนผู้ที่้สัมผัสเชื้อพิษสุนัขบ้าได้รับการฉีดวัคซีน PCEC  ทั้งหมด นอกเขตรับผิดชอบ',
                                                          ['/suka/suka4-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานจำนวนผู้ที่้สัมผัสเชื้อพิษสุนัขบ้าได้รับการฉีดวัคซีน PCEC  ทั้งหมด นอกเขตรับผิดชอบ',
                                                          ['site/modal'],
