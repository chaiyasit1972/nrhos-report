                          ...
                          <a class="btn-u btn-u-green" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse3">
                             ...
                             <ul id="collapse3" class="collapse">
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. อัตราตายจาก Sepsis/Septic Shock เป้าหมาย <  &nbsp;ร้อยละ 30 (แยกโรค)',
                                                          ['/service-plan/service-plan603_4','year'=>'25'.$select1]) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. อัตราตายจาก Sepsis/Septic Shock เป้าหมาย <  &nbsp;ร้อยละ 30 (แยกโรค)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. อัตราตายจากการติดเชื้อในกระแสเลือด (Community Acquired Sepsis)
                                                              เป้าหมาย <  &nbsp;ร้อยละ 30 (Comorbidity)',
                                                          ['/service-plan/service-plan603_5','year'=>'25'.$select1]) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. อัตราตายจากการติดเชื้อในกระแสเลือด (Community Acquired Sepsis)
                                                              เป้าหมาย <  ร้อยละ 30 (Comorbidity)',
                                                          ['site/modal'],
