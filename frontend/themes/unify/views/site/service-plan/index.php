        ...
        <div class="tag-box tag-box-v3 form-page">  
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="headline col col-md-3 indent has-warning"> 
                        <label class="control-labell" for="inputWarning"><h4>เลือกปีงบประมาณ :</h4>
                        </label>
                    </div>
                <div class="col col-md-4 indent headline has-warning">
                      <label class="control-labell" for="inputWarning"><h4>
                                <?php
                                            echo Select2::widget([
                                                'model' => $model,
                                                'attribute' => 'select1',
