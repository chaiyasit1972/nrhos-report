            ...
            <ul class="list-group sidebar-nav-v1 lists-v1" id="sidebar-nav">
                      <li class="list-group-item list-toggle">
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             <span class='h5 margin-left-10'>คลิกเลือกรายงานทั่วไป !!</span>                             
                         </a>   
                            <ul id="collapse1" class="collapse">
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          22. รายงานผู้ป่วยที่ Admit จาก Er แล้วส่งต่อผู้ป่วยภายใน 6 ชั่วโมง',
                                                          ['/er/er22']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          22. รายงานผู้ป่วยที่ Admit จาก Er แล้วส่งต่อผู้ป่วยภายใน 6 ชั่วโมง',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          23. รายงานรับส่งต่อผู้ป่วย(refer in) ที่มีค่า RW <= 0.5 โรงพยาบาลเครือข่าย',
                                                          ['/er/er23']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          23. รายงานรับส่งต่อผู้ป่วย(refer in) ที่มีค่า RW <= 0.5 โรงพยาบาลเครือข่าย',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          24. รายงานรับส่งต่อผู้ป่วย(refer in) โรงพยาบาลเครือข่าย เพื่อทำ CT แล้วส่งต่อ รพ.แม่ข่าย',
                                                          ['/er/er24']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          24. รายงานรับส่งต่อผู้ป่วย(refer in) โรงพยาบาลเครือข่าย เพื่อทำ CT แล้วส่งต่อ รพ.แม่ข่าย',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          25. รายงานระยะเวลาการดูแลผู้ป่วยอุบัติเหตุฉุกเฉินแยกตามระดับความรุนแรง(emergency_level)',
                                                          ['/er/er25']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          25. รายงานระยะเวลาการดูแลผู้ป่วยอุบัติเหตุฉุกเฉินแยกตามระดับความรุนแรง(emergency_level)',
                                                          ['site/modal'],
                      ...
                      <li class="list-group-item list-toggle">
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse2">
                             <span class='h5 margin-left-10'>คลิกเลือกรายงานตัวชี้วัด</span>                             
                         </a>   
                             <ul id="collapse2" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานตัวชีวัดปีงบประมาณ 2561',
                                                          ['/er/er-kpi61-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานตัวชีวัดปีงบประมาณ 2561',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานตัวชีวัดปีงบประมาณ 2562',
                                                          ['/er/er-kpi62-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานตัวชีวัดปีงบประมาณ 2561',
                                                          ['site/modal'],
                                                          [
                                                                 'class' => 'xmodal',
                                                                 'title' => 'เปิดดูข้อมูล',
