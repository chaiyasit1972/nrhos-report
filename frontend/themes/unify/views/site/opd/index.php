        ...
        <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?= $baseUrl ?>/assets/img/opd2.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/opd3.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/opd1.jpg" alt="">
                </div>          
            </div>
                          ...
                          <a class="btn-u btn-u-green" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานยอดผู้ป่วยนอก(9 แผนกหลัก) ',
                                                          ['/opd/opd1-index']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานยอดผู้ป่วยนอก(9 แผนกหลัก) ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานผู้ป่วยนอกแยกตามแผนก(9 แผนกหลัก)',
                                                          ['/opd/opd2-index']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานผู้ป่วยนอกแยกตามแผนก(9 แผนกหลัก)',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงาน 10 อันดับโรคผู้ป่วยนอก(9 แผนกหลัก)',
                                                          ['/opd/opd3-index']) :                                       
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงาน 10 อันดับโรคผู้ป่วยนอก(9 แผนกหลัก)',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานการกลับมารักษาซ้ำภายใน 48 ชม.ผู้ป่วยนอก(9 แผนกหลัก)',
                                                          ['/opd/opd4-index']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานการกลับมารักษาซ้ำภายใน 48 ชม.ผู้ป่วยนอก(9 แผนกหลัก)',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงาน 10 อันดับโรคการส่งต่อผู้ป่วยนอก(9 แผนกหลัก)',
                                                          ['/opd/opd5-index']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงาน 10 อันดับโรคการส่งต่อผู้ป่วยนอก(9 แผนกหลัก)',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6. รายงานจำนวนผู้รับบริการผู้ป่วยนอก (OPD) แยกตามห้องตรวจ ในวันเวลาราชการ (08.00 - 16.00 น.)',
                                                          ['/opd/opd6-index']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          6. รายงานจำนวนผู้รับบริการผู้ป่วยนอก (OPD) แยกตามห้องตรวจ ในวันราชการ (08.00 - 16.00 น.)',
                                                          ['site/modal'],
                                                          [
                                                                 'class' => 'xmodal',
                                                                 'title' => 'เปิดดูข้อมูล',
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          7. รายงานจำนวนผู้รับบริการผู้ป่วยนอก (OPD) ได้รับการตรวจและกลับบ้าน ตามช่วงเวลา',
                                                          ['/opd/opd7-index']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          7. รายงานจำนวนผู้รับบริการผู้ป่วยนอก (OPD) ได้รับการตรวจและกลับบ้าน ตามช่วงเวลา',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          8. รายงานจำนวนผู้รับบริการผู้ป่วยนอก แผนกจักษุ สิทธิ UC(ผู้สูงอายุ) ได้รับการตรวจคัดกรองตา',
                                                          ['/opd/opd8-index']) :
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          8. รายงานจำนวนผู้รับบริการผู้ป่วยนอก แผนกจักษุ สิทธิ UC(ผู้สูงอายุ) ได้รับการตรวจคัดกรองตา',
                                                          ['site/modal'],
