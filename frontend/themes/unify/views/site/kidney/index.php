...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=Html::a($sText,['#']);?></li>
            <li><?=Html::a($mText,['/kidney/index']);;?></li>
        </ul>
    </div>
</div>
       ...
       <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?= $baseUrl ?>/assets/img/kidney2.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/kidney1.png" alt="">
                </div>          
            </div>
                      ...
                      <li class="list-group-item list-toggle">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. ทะเบียนผู้ป่วยคลิกนิกโรคไต(สถานะ ยังรักษาอยู่,ส่งต่อรักษาที่อื่น)',
                                                          ['/kidney/kidney1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. ทะเบียนผู้ป่วยคลิกนิกโรคไต(สถานะ ยังรักษาอยู่,ส่งต่อรักษาที่อื่น)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานคัดกรองภาวะไตวาย (eGFR)', 
                                                          ['/kidney/kidney2-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานคัดกรองภาวะไตวาย (eGFR)', 
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานมาตรฐานตัวชี้วัดตามสมาคมโรคไต(15 ตัวชี้วัด) ',
                                                          ['/kidney/kidney3-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานมาตรฐานตัวชี้วัดตามสมาคมโรคไต(15 ตัวชี้วัด) ',
                                                          ['site/modal'],
                                                          [
...
?> 
 <?php
        ...
        Modal::end();
 ?>       
<div class="margin-bottom-100"></div>&nbsp;<div class="margin-bottom-70"></div>