                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานการให้บริการหญิงตั้งครรภ์(ANC) ',
                                                          ['/anc/index1']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานการบริการหญิงตั้งครรภ์ ',
                                                          ['site/modal'],
                                                          [
                                                                 'class' => 'xmodal',
                                                                 'title' => 'เปิดดูข้อมูล',
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานการรับส่งต่อ(Refer-In)ผู้ป่วยแผนกสูติกรรม(OPD+ANC) ',
                                                          ['/anc/index4']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานการรับส่งต่อ(Refer-In)ผู้ป่วยแผนกสูติกรรม(OPD+ANC) ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานการรับส่งต่อ(Refer-Out)ผู้ป่วยแผนกสูติกรรม(OPD+ANC) ',
                                                          ['/anc/index5']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. รายงานการรับส่งต่อ(Refer-Out)ผู้ป่วยแผนกสูติกรรม(OPD+ANC) ',
                                                          ['site/modal'],
