...
<div class="breadcrumbs">
    <div class="container">
        <h4 class="pull-left">งานอนามัยแม่และเด็ก</h4>
        <ul class="pull-right breadcrumb">
            <li><?=Html::a('Home',['/site/index']);?></li>
            <li><?=Html::a($mText,['/mom-child/index']);?></li>
        </ul>
    </div>
</div>
                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานสรุป งานอนามัยแม่และเด็ก ',
                                                          ['/mom-child/index1']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานสรุป งานอนามัยแม่และเด็ก ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานร้อยละของ ANC ที่ได้รับการฝากครรภ์ครั้งแรกภายใน 12 week',
                                                          ['/mom-child/index2']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานร้อยละของ ANC ที่ได้รับการฝากครรภ์ครั้งแรกภายใน 12 week',
                                                          ['site/modal'],
                                                          [
                                                                 'class' => 'xmodal',
                                                                 'title' => 'เปิดดูข้อมูล',
