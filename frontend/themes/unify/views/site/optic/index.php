...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=Html::a($sText,['/optic/index']);;?></li>
            <li class="active"><?=$mText;?></li>            
        </ul>
    </div>
</div>
       ...
       <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?= $baseUrl ?>/assets/img/opt1.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/opt2.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/opt3.jpg" alt="">
                </div>          
            </div>
                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานการส่งต่อ(refer-out) ผู้ป่วยโรคตา ',
                                                          ['/optic/optic1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานการส่งต่อ(refer-out) ผู้ป่วยโรคตา ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานผู้ป่วยต้อกระจก(ผู้ป่วยนอก) H544 ที่ยังไม่ได้รับการผ่าตัด ',
                                                          ['/optic/optic2-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานผู้ป่วยต้อกระจก(ผู้ป่วยนอก) H544 ที่ยังไม่ได้รับการผ่าตัด ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงาน 10 อันดับโรค ผู้ป่วยนอกแผนกจักษุ',
                                                          ['/optic/optic3-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงาน 10 อันดับโรค ผู้ป่วยนอกแผนกจักษุ',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานการรับการส่งต่อ(refer-in) ผู้ป่วยโรคตา ',
                                                          ['/optic/optic4-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. รายงานการรับการส่งต่อ(refer-in) ผู้ป่วยโรคตา ',
                                                          ['site/modal'],
