...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=$sText ;  ?></li>
            <li class="active"><?=Html::a($mText,['/vetrabean/index']);?></li>            
        </ul>
    </div>
</div>
            ...
            <div class="panel">
                <div class="panel-body"><div class="col col-md-1"></div>
                    ...
                    <div class="col col-md-4">
                        <div class="form-group has-success">
                            <label class="control-label" > กรอกจำนวนเตียง :
                             <?= $form->field($model, 'text1')->textInput(['placeholder' =>'',
                                           'style' =>'width:70px;text-align:center;','value' => 0])->label('กรอกจำนวนเตียง :');   
                             ?>
                            </label>    
                        </div>                                                  
                    </div>
