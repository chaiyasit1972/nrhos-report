                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานสรุปผลการปฎิบัติงานแผนกชันสูตร(OPD,IPD)ตามใบ LAB ในเวลา(08.00 - 16.00)',
                                                          ['/lab/index1']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานสรุปผลการปฎิบัติงานแผนกชันสูตร(OPD,IPD)ตามใบ LAB ในเวลา(08.00 - 16.00)',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานระยะเวลารอคอยการสั่ง Lab รับใบ Lab และ รายงานผล Lab แยกตาม รายการใบ Lab',
                                                          ['/lab/index2']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานระยะเวลารอคอยการสั่ง Lab รับใบ Lab และ รายงานผล Lab แยกตาม รายการใบ Lab',
                                                          ['site/modal'],
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานระยะเวลารอคอยผล Lab แยกราย',
                                                          ['/lab/index3']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. รายงานระยะเวลารอคอยผล Lab แยกราย',
                                                          ['site/modal'],
